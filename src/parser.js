module.exports = // @generated by Peggy 4.0.3.
    ...
    (function () {
        ...
        function peg$parse(input, options) {
            ...
            var peg$f3 = function (term, num, range) {
                const rep = num;
                const result = [];
                ...
                for (
                    ...
                    if (typeof term === 'string') {
                        ...
                        result.push(
                            term.map((e) => e.replace(/\$+/g, repl(i)))
                        );
                    }
                }
                return result;
            };
            var peg$f4 = function (nstart, nstep) {
                return { nstart, nstep };
            };
            var peg$f5 = function (num) {
                return Number(num.join(''));
            };
            var peg$f6 = function (stuff) {
                return stuff.join('');
            };
